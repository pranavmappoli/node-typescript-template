# node-typescript-template (with Hot-Reload)
...
- [TypeScript][typescript] [5.2][typescript-5-1]
- Node js @20.5
- Hot Reload
- Important module added for production ready
- [ESM][esm]
...
```sh
git clone https://github.com/pranavmappoli/node-typescript-template.git
...
[repo-template-action]: https://github.com/new?template_name=node-typescript-template&template_owner=pranavmappoli
